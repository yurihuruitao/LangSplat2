...
cd autoencoder
python train.py --dataset_path $dataset_path --encoder_dims 256 128 64 32 3 --decoder_dims 16 32 64 128 256 256 512 --lr 0.0007 --dataset_name ramen_try
...
for level in 2 3
do
    python train.py -s /home/ubuntu/langsplat/LangSplat/datasets/lerf_ovs/ramen -m output/ramen --start_checkpoint /home/ubuntu/langsplat/LangSplat/datasets/lerf_ovs/ramen/chkpnt30000.pth --feature_level ${level}
